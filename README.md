...
Created with Claude Code - Anthropic's AI coding assistant
...
**Note**: This is a fully functional offline expense tracker app. All data is stored locally on your device using Room database. No internet connection required.
